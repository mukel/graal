...
/**
 * High-level regression test for GR-13757: {@code Float.float16ToFloat} and
...
public class AMD64Float16ConversionCompilationTest extends GraalCompilerTest {
    ...
    public static void float16ToFloatKernel(short[] in, float[] out, int iters) {
        ...
        out[5] = a5; out[6] = a6; out[7] = a7; out[8] = a8; out[9] = a9;
        out[10] = a10; out[11] = a11; out[12] = a12; out[13] = a13; out[14] = a14;
        out[15] = a15; out[16] = a16; out[17] = a17; out[18] = a18; out[19] = a19;
    }
    ...
    public static void floatToFloat16Kernel(float[] in, short[] out, int iters) {
        ...
        for (int i = 1; i < iters; i++) {
            int b = i * N;
            a0 += in[b + 0]; a1 += in[b + 1]; a2 += in[b + 2]; a3 += in[b + 3]; a4 += in[b + 4];
            a5 += in[b + 5]; a6 += in[b + 6]; a7 += in[b + 7]; a8 += in[b + 8]; a9 += in[b + 9];
            a10 += in[b + 10]; a11 += in[b + 11]; a12 += in[b + 12]; a13 += in[b + 13]; a14 += in[b + 14];
            a15 += in[b + 15]; a16 += in[b + 16]; a17 += in[b + 17]; a18 += in[b + 18]; a19 += in[b + 19];
        }
        out[0] = Float.floatToFloat16(a0); out[1] = Float.floatToFloat16(a1); out[2] = Float.floatToFloat16(a2);
        out[3] = Float.floatToFloat16(a3); out[4] = Float.floatToFloat16(a4); out[5] = Float.floatToFloat16(a5);
        out[6] = Float.floatToFloat16(a6); out[7] = Float.floatToFloat16(a7); out[8] = Float.floatToFloat16(a8);
        out[9] = Float.floatToFloat16(a9); out[10] = Float.floatToFloat16(a10); out[11] = Float.floatToFloat16(a11);
        out[12] = Float.floatToFloat16(a12); out[13] = Float.floatToFloat16(a13); out[14] = Float.floatToFloat16(a14);
        out[15] = Float.floatToFloat16(a15); out[16] = Float.floatToFloat16(a16); out[17] = Float.floatToFloat16(a17);
        out[18] = Float.floatToFloat16(a18); out[19] = Float.floatToFloat16(a19);
    }
    ...
    public void float16ToFloatWithHighRegisters() {
        ...
        assertTrue("no AMD64HalfFloatToFloatOp landed in an AVX-512 high register; "
                        + "the register-pressure scenario was not exercised", halfFloatToFloatHigh);
    }
    ...
    public void floatToFloat16WithHighRegisters() {
        ...
        assertTrue("no AMD64FloatToHalfFloatOp used an AVX-512 high register; "
                        + "the register-pressure scenario was not exercised", floatToHalfFloatHigh);
    }
